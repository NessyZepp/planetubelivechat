...
import { UserRegistrationModel } from '../../../models/user/user-registration';
...
export declare module UserNotificationIncludes {
    ...
    type VideoCommentInclude = Pick<VideoCommentModel, 'id' | 'originCommentId' | 'getThreadId'> & PickWith<VideoCommentModel, 'Account', AccountIncludeActor> & PickWith<VideoCommentModel, 'Video', VideoInclude>;
