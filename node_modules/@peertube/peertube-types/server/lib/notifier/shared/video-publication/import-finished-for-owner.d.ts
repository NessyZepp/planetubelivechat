import { MUserDefault, MUserWithNotificationSetting, MVideoImportVideo, UserNotificationModelForApi } from '../../../../types/models';
...
export declare class ImportFinishedForOwner extends AbstractNotification<ImportFinishedForOwnerPayload> {
    ...
    log(): void;
    getSetting(user: MUserWithNotificationSetting): import("../../../../../shared/models").UserNotificationSettingValue;
