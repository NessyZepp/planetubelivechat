...
import { ActivitypubFollowPayload, ActivitypubHttpBroadcastPayload, ActivitypubHttpFetcherPayload, ActivitypubHttpUnicastPayload, ActorKeysPayload, AfterVideoChannelImportPayload, DeleteResumableUploadMetaFilePayload, EmailPayload, FederateVideoPayload, JobState, JobType, ManageVideoTorrentPayload, MoveObjectStoragePayload, NotifyPayload, RefreshPayload, TranscodingJobBuilderPayload, VideoChannelImportPayload, VideoFileImportPayload, VideoImportPayload, VideoLiveEndingPayload, VideoRedundancyPayload, VideoStudioEditionPayload, VideoTranscodingPayload } from '../../../shared/models';
export type CreateJobArgument = {
    ...
    payload: MoveObjectStoragePayload;
} | {
...
declare class JobQueue {
    ...
    createJob(options: CreateJobArgument & CreateJobOptions): Promise<Job<any, any, string>>;
