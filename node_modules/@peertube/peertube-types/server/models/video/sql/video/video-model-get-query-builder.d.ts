 ...
 *
 */
export type GetType = 'api' | 'full' | 'account-blacklist-files' | 'all-files' | 'thumbnails' | 'thumbnails-blacklist' | 'id' | 'blacklist-rights';
...
export declare class VideoModelGetQueryBuilder {
    ...
    queryVideo(options: BuildVideoGetQueryOptions): Promise<import("../../video").VideoModel>;
