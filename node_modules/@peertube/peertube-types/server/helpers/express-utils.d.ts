...
declare function badRequest(_req: express.Request, res: express.Response): express.Response<any>;
...
export { buildNSFWFilter, getHostWithPort, createAnyReqFiles, isUserAbleToSearchRemoteURI, badRequest, createReqFiles, cleanUpReqFiles, getCountVideos };
