...
declare function isTestInstance(): boolean;
declare function isTestOrDevInstance(): boolean;
declare function isProdInstance(): boolean;
declare function getAppNumber(): string;
...
export { isTestInstance, isTestOrDevInstance, isProdInstance, getAppNumber, objectConverter, mapToJSON, sanitizeUrl, sanitizeHost, execShell, pageToStartAndCount, peertubeTruncate, scryptPromise, randomBytesPromise, generateRSAKeyPairPromise, generateED25519KeyPairPromise, execPromise2, execPromise, pipelinePromise, parseSemVersion };
